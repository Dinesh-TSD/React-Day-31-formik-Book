      ...
      <div className="container-fluid head ">
        <div className="row">
          <div className="col-8">
            ...
            <Link to={'/create-author'} className="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm create" ><i
              className="fas fa-download fa-sm text-white-50"></i> Create Author</Link>
            <Link to={'/upload-book'} className="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm create"><i
